 ...
 * Description: Class to represent the Word information in a TuBaTreeBank export file
 *
 * Honor Code:  I pledge that this program represents my own work.
 *  I received help from nobody in designing and debugging my program.
 *
 * A class to represent the Word information in a TuBaTreeBank export file
 */
public class Word
{
    private String form;
